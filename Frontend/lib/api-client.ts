...
export const apartmentsAPI = {
  ...
  update: (id: string, data: any) =>
    apiClient.put(`/appartments/update/${id}`, data),
...
export const mansionsAPI = {
  ...
  update: (id: string, data: any) =>
    apiClient.put(`/mansions/update/${id}`, data),
...
export const yachtsAPI = {
  ...
  update: (id: string, data: any) =>
    apiClient.put(`/yachts/update/${id}`, data),
...
export const conciergeAPI = {
  ...
  update: (id: string, data: any) =>
    apiClient.put(`/concierge/update/${id}`, data),
